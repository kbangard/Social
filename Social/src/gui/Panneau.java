...
public class Panneau extends JPanel {
	...
	public void initActions() {
		...
		jb11.addActionListener(new AddAction());
}
	
	public void initLayout() {
		//Button 1
		setLayout(null);
		jb1.setIcon(new ImageIcon("src/img_projet/man90.png"));
		...
		//Button 2
		jb2.setIcon(new ImageIcon("src/img_projet/user-1_75.png"));
		...
		//Button 3
		jb3.setIcon(new ImageIcon("src/img_projet/user75.png"));
		...
		//Button 4
		jb4.setIcon(new ImageIcon("src/img_projet/user-20_75.png"));
		jb4.setBounds(START_X+100,START_Y-40,75,75);
		...
		//Button 5
		jb5.setIcon(new ImageIcon("src/img_projet/user-2_70.png"));
		...
		//Button 6
		jb6.setIcon(new ImageIcon("src/img_projet/user-4_70.png"));
		...
		//Button 7
		jb7.setIcon(new ImageIcon("src/img_projet/user-15_70.png"));
		...
		//Button 8
		jb8.setIcon(new ImageIcon("src/img_projet/user-19_70.png"));
		...
		//Button 9
		jb9.setIcon(new ImageIcon("src/img_projet/user-10_70.png"));
		...
		//Button 10
		jb10.setIcon(new ImageIcon("src/img_projet/user-16_70.png"));
		jb10.setBounds(START_X+450,START_Y,70,70);
		...
		//Button 11
		jb11.setIcon(new ImageIcon("src/img_projet/user-17_70.png"));
		jb11.setBounds(START_X+600,START_Y+60,70,70);
