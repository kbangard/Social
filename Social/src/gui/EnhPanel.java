...
public class EnhPanel extends JPanel {
	...
	public void initLayout() {
		//Button 1
				setLayout(null);
				jb1.setIcon(new ImageIcon("src/img_projet/student_90.png"));
				...
				//Button 2
				jb2.setIcon(new ImageIcon("src/img_projet/user-12_75.png"));
				...
				//Button 3
				jb3.setIcon(new ImageIcon("src/img_projet/user-14_75.png"));
				...
				//Button 4
				jb4.setIcon(new ImageIcon("src/img_projet/reading_70.png"));
