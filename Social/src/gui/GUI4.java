...
public class GUI4 extends JFrame implements Runnable {
	 ...
	 */
	private GUI4 instance = this;

	/**
	 * Initial status of for the start button.
	 */
	private boolean stop = true;
	private EnfPanel panneau;
	
	public GUI4(String title) {
		super(title);
		init();
	...
	public static void main(String[] args) {
		GUI4 simulation = new GUI4("Social Simulation");
